...
public class PetCloudStoreTelemetryClient extends com.microsoft.applicationinsights.TelemetryClient {
	private static String message = "azure.application-insights.instrumentation-key not found, consider configuring Application Inisghts if you would like to track Telemetry.";
	private static Logger logger = LoggerFactory.getLogger(PetCloudStoreTelemetryClient.class);
